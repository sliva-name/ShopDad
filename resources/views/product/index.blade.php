...
{{--                </div>--}}
            ...
            <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
                ...
                <div class="mt-4 lg:row-span-3 lg:mt-0">
                    ...
                    <form method="post" action="{{ route('cart.add', $product->id) }}" class="mt-10">
                        @csrf
                    ...
                    <div class="mt-10">
                        ...
                        <div class="mt-4">
                            <ul role="list" class="list-disc space-y-2 pl-4 text-sm">
                                @foreach($product->parameters as $param => $value)
                                <li class="text-gray-400"><span class="font-medium text-gray-900">{{ $param }}:</span><span class="ml-2 text-gray-600">{{ $value }}</span></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
