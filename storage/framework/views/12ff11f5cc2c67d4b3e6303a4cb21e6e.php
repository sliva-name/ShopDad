...
<div <?php echo e($attributes->merge(['class' => 'flex flex-wrap items-center gap-2']), false); ?>>
...
<?php $component = MoonShine\Components\Dropdown::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = MoonShine\Components\Icon::resolve(['icon' => 'heroicons.ellipsis-vertical'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
            ...
            <ul class="dropdown-menu">
                <?php $__currentLoopData = $actions->inDropdown(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="dropdown-menu-item">
                        <?php echo e($action->render(), false); ?>
...
<?php /**PATH D:\OSPanel\domains\ShopDad\vendor\moonshine\moonshine\src\Providers/../../resources/views/components/action-group.blade.php ENDPATH**/ ?>