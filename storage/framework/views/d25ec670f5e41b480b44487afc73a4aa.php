                ...
                <div class="flex h-16 items-center">
                    ...
                    <div class="ml-4 flex lg:ml-0">
                        <a href="<?php echo e(route('home'), false); ?>">
                            ...
                            <img class="h-12 w-auto" src="<?php echo e(asset('logo.png'), false); ?>" alt="logo-header">
                        </a>
                    </div>
                        ...
                        <div class="flex h-full space-x-8">
                            <div class="flex">
                                <div class="relative flex">
                                    ...
                                    <a href="<?php echo e(route('home'), false); ?>" class="border-transparent text-gray-700 hover:border-indigo-600 focus:border-indigo-600 focus:text-indigo-600 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out" aria-expanded="false">
                                        Каталог
                                    </a>
                                </div>
                            ...
                            <a href="<?php echo e(route('order.get'), false); ?>" class="border-transparent text-gray-700 hover:border-indigo-600 focus:border-indigo-600 focus:text-indigo-600 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out">О нас</a>
                            <a href="<?php echo e(route('order.get'), false); ?>" class="border-transparent text-gray-700 hover:border-indigo-600 focus:border-indigo-600 focus:text-indigo-600 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out">Контакты</a>
                        </div>
                    </div>
                    ...
                    <div class="ml-auto flex items-center">
                        ...
                        <div class="ml-4 flow-root lg:ml-6">
                            <a href="<?php echo e(route('cart.index'), false); ?>" class="group -m-2 flex items-center p-2">
                                ...
                                <?php if(auth()->guard()->check()): ?>
                                <span class="ml-2 text-sm font-medium text-gray-700 group-hover:text-gray-800"><?php echo e(\Cart::session(\Auth::user()->id)->getContent()->count(), false); ?></span>
