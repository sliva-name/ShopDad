                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-6">
                    ...
                    <div class="group p-6 border border-gray-200 rounded-lg hover:translate-y-1 transition ease-in-out">
                        ...
                        <div class="flex flex-col gap-3 mt-6">
                            <a href="<?php echo e(route('product', $product->id), false); ?>" class="text-lg text-gray-900 font-medium hover:text-indigo-600"><?php echo e($product->title, false); ?></a>
                            <p class="text-lg font-bold text-gray-900"><?php echo e($product->price, false); ?> руб.</p>
                            ...
                            <form method="post" action="<?php echo e(route('cart.add', $product->id), false); ?>">
                                <?php echo csrf_field(); ?>
