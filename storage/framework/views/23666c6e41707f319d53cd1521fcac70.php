...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('login'), false); ?>">
                <?php echo e(__('Уже зарегистрированы?'), false); ?>
...
<?php $component->withAttributes(['class' => 'ml-4']); ?>
                <?php echo e(__('Зарегистрироваться'), false); ?>
...
<?php endif; ?>
<?php /**PATH D:\OSPanel\domains\ShopDad\resources\views/auth/register.blade.php ENDPATH**/ ?>