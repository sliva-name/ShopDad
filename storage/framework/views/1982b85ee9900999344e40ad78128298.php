<?php $__env->startSection('content'); ?>
    <div class="authentication">
        <div class="authentication-logo">
            <a href="/" rel="home">
                <img class="h-16"
                     src="<?php echo e(asset(config('moonshine.logo') ?? 'vendor/moonshine/logo.svg'), false); ?>"
...
<?php echo $__env->make("moonshine::layouts.login", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\ShopDad\vendor\moonshine\moonshine\src\Providers/../../resources/views/auth/login.blade.php ENDPATH**/ ?>