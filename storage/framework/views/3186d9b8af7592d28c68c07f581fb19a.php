...
<?php endif; ?>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ml-2 text-sm text-gray-600"><?php echo e(__('Запомнить меня'), false); ?></span>
            </label>
        </div>
        ...
        <div class="flex items-center justify-end mt-4">
            <?php if(Route::has('password.request')): ?>
                <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('password.request'), false); ?>">
                    <?php echo e(__('Забыли пароль?'), false); ?>
...
<?php endif; ?>
<?php /**PATH D:\OSPanel\domains\ShopDad\resources\views/auth/login.blade.php ENDPATH**/ ?>